...
LOCAL_SHARED_LIBRARIES := \
    ...
    libext2_com_err \
    libext2_e2p
LOCAL_STATIC_LIBRARIES := libss
LOCAL_SYSTEM_SHARED_LIBRARIES := libc
LOCAL_MODULE := libe2freefrag
LOCAL_MODULE_TAGS := optional
...
LOCAL_SRC_FILES := hw_e4defrag.c
LOCAL_C_INCLUDES := $(blkid_c_includes)
LOCAL_CFLAGS := $(blkid_cflags) -DHAVE_POSIX_FADVISE -DHAVE_FALLOCATE64 -DUSE_ANDROID_LOG
LOCAL_STATIC_LIBRARIES := $(hw_e4defrag_static_libraries) $(hw_e4defrag_system_static_libraries)
LOCAL_FORCE_STATIC_EXECUTABLE := true
LOCAL_MODULE := e4defrag
LOCAL_MODULE_TAGS := optional
#LOCAL_ODM_MODULE := true
LOCAL_CFLAGS += -Werror
