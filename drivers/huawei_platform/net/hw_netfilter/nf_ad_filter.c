...
{
pr_err("hwad: uninit_ad 111 yyc\n");
printk("hwad: uninit_ad 222  yyc\n");
    int i = 0;
    struct ad_rule *node = NULL;
    struct ad_url *temp = NULL;
