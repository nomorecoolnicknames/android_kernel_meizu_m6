...
#define HX_FW_NAME "touch_screen_firmware.bin"
extern bool upgrade_from_sd;
...
static int gest_most_left_x=0,gest_most_left_y=0,gest_most_right_x=0,gest_most_right_y=0,gest_most_top_x=0,gest_most_top_y=0,gest_most_bottom_x=0,gest_most_bottom_y=0;
...
#ifdef HMX852xF
#define	HX_REG_FLASH_MANUAL_MODE	0x35
#else //HMX852xE
...
#ifdef HMX852xF
#define	HAND_SHAKE_READING			0xD1
#else //HMX852xE
#define	HAND_SHAKE_READING			0x90
#endif
...
struct himax_ts_data {
	...
	struct wake_lock ts_gesture_wake_lock;
#if defined(CONFIG_FB)
...
extern int  himax_chip_monitor_hand_shaking(void);
extern void himax_get_information(void);
extern irqreturn_t himax_ts_thread(int irq, void *ptr);
extern int diag_command;
