...
MUINT32 leds_AW3643_FlashlightInit(FLASHLIGHT_FUNCTION_STRUCT **pfFunc);
...
/* dual-flash */
int flashEnable_rt5081_2(void);
int flashDisable_rt5081_2(void);
int setDuty_rt5081_2(int duty);
#endif
