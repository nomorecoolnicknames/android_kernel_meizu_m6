...
/*OV*/
/*jijin.wang add 1st main camera interface*/
...
/*S5K*/
/*jijin.wang add camera sensor interface*/
...
{
/*add camera sensor list start*/
#if defined(IMX278_MIPI_RAW)
	    {IMX278_SENSOR_ID, SENSOR_DRVNAME_IMX278_TRULY_MIPI_RAW, IMX278_MIPI_RAW_SensorInit},
	    {IMX278_SENSOR_ID, SENSOR_DRVNAME_IMX278_MIPI_RAW, IMX278_MIPI_RAW_SensorInit},
#endif
#if defined(OV8856JSL_MIPI_RAW)
	    {OV8856_SENSOR_ID, SENSOR_DRVNAME_OV8856_MIPI_RAW, OV8856JSLMIPIRAW_SensorInit},
	    {OV8856JSL_SENSOR_ID, SENSOR_DRVNAME_OV8856JSL_MIPI_RAW, OV8856JSLMIPIRAW_SensorInit},
#endif
...
#endif
#if defined(HI846_MIPI_RAW_HOLI)
	    {HI846_SENSOR_ID_HOLI, SENSOR_DRVNAME_HI846_MIPI_RAW_HOLI,HI846_MIPI_RAW_SensorInit_Holi},
#endif
/*add camera sensor list end*/
/*IMX*/
