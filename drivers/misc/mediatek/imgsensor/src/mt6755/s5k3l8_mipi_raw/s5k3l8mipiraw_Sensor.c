...
//#define printk_LOD(format, args...)	pr_debug(PFX,"[%s] " format, __FUNCTION__, ##args)
...
static void sensor_init(void)
{
  printk("E\n");
	...
	#endif
	write_cmos_sensor_byte(0xB0C8, 0x03);	//0x01, 0x02, 0x03 fae s5k3l8
...
//$MV1[MCLK:24,Width:2104,Height:1560,Format:MIPI_Raw10,mipi_lane:4,mipi_datarate:1124,pvi_pclk_inverse:0]
  ...
  write_cmos_sensor(0x030E, 0x0113);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		#endif
        app_info_set("camera_main","S5K3L8-HELI");
                return ERROR_NONE;
            }
