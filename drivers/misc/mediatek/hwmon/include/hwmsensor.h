...
#define SENSOR_TYPE_CAPTOUCH          (10005)
...
#define ID_CAPTOUCH                         (ID_BASE+SENSOR_TYPE_CAPTOUCH-1)
#define ID_SENSOR_MAX_HANDLE                (ID_BASE+SENSOR_TYPE_CAPTOUCH)
...
#define SENSOR_CAPTOUCH                     (1 << CAPTOUCH)
