...
/*
 * Same as get_user_pages(), but migrate before pin page,
 * if page pinning on CMA page
 */
static inline long get_user_pages_durable(struct task_struct *tsk, struct mm_struct *mm,
			unsigned long start, unsigned long nr_pages, int write,
			int force, struct page **pages, struct vm_area_struct **vmas)
{
