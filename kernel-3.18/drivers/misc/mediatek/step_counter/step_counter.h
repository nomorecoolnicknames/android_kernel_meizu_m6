...
#define EVENT_TYPE_STEP_UPDATE              REL_X
#define EVENT_TYPE_STEP_TIMESTAMP_HI		REL_HWHEEL
#define EVENT_TYPE_STEP_TIMESTAMP_LO		REL_DIAL
...
extern int step_c_data_report(struct input_dev *dev, uint32_t value, int status, int64_t nt);
