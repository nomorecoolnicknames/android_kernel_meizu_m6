...
#define BMA421_FEATURE_SIZE            UINT8_C(60)
#define BMA421_ANYMOTION_EN_LEN            UINT8_C(2)
#define BMA421_RD_WR_MIN_LEN            UINT8_C(2)
#define BMA421_FEATURE_SEL_LEN            UINT8_C(6)

/**\name Feature offset address */
#define BMA421_CONFIG_ID_OFFSET            UINT8_C(0x38)
#define BMA421_AXES_REMAP_OFFSET        UINT8_C(0x3A)
#define BMA421_STEP_CNTR_OFFSET            UINT8_C(0x04)
#define BMA421_STEP_CNTR_PARAM_OFFSET        UINT8_C(0x06)
...
#define BMA421_STEP_CNTR_WM_POS            UINT8_C(0)
...
/**\name Platform configuration selection macros */
#define BMA421_PLATFORM_SEL_POS            UINT8_C(6)
#define BMA421_PLATFORM_SEL_MSK            UINT8_C(0x40)
...
#define BMA421_ANY_NO_MOTION_DUR_POS            UINT8_C(0)
