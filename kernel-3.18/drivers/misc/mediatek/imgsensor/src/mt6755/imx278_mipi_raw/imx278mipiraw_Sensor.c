...
static void preview_setting(void)   //PreviewSetting
{
  ...
  write_cmos_sensor(0x0404, 0x00);//Scale factor[8]
   ...
   write_cmos_sensor(0x0600, 0x00);// [M6DIAG#206] test-pattern mode MSB
   write_cmos_sensor(0x0601, 0x02);// [M6DIAG#206] FORCE color-bar test pattern (transport-vs-analog probe)
