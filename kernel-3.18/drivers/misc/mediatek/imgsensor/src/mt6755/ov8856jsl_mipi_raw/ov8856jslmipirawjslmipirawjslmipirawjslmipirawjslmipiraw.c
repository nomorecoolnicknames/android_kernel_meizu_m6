 ...
 * Filename:
 * ---------
 *	 OV8856JSLMIPIRAWJSLMIPIRAWmipiraw_sensor.c
 *
 * Project:
 * --------
 *	 ALPS MT6795
...
#include "ov8856jslmipirawjslmipirawjslmipirawjslmipirawjslmipiraw.h"

#define PFX "OV8856JSLMIPIRAWJSLMIPIRAW"

//#define OV8856JSLMIPIRAWJSLMIPIRAWR1AOTP
...
typedef enum {
	OV8856JSLMIPIRAWJSLMIPIRAWR2A,
	OV8856JSLMIPIRAWJSLMIPIRAWR1A
}OV8856JSLMIPIRAWJSLMIPIRAW_VERSION;

OV8856JSLMIPIRAWJSLMIPIRAW_VERSION ov8856jslmipirawjslmipirawjslmipirawjslmipirawversion = OV8856JSLMIPIRAWJSLMIPIRAWR1A;

static DEFINE_SPINLOCK(imgsensor_drv_lock);

extern void ov8856jslmipirawjslmipirawjslmipirawjslmipirawjslmipiraw_update(void);

static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = OV8856JSLMIPIRAWJSLMIPIRAW_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
			...
			*sensor_id = ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
            if (*sensor_id == imgsensor_info.sensor_id) {
              if((read_cmos_sensor(0x302A)) == 0xB0){
                ov8856jslmipirawjslmipirawjslmipirawjslmipirawversion = OV8856JSLMIPIRAWJSLMIPIRAWR1A;
                LOG_INF("i2c write id: 0x%x, sensor id: 0x%x, ov8856jslmipirawjslmipirawjslmipirawjslmipirawversion = %d(0=r2a,1=r1a)\n", imgsensor.i2c_write_id,*sensor_id,ov8856jslmipirawjslmipirawjslmipirawjslmipirawversion);	
                return ERROR_NONE;
              }
              else if((read_cmos_sensor(0x302A)) == 0xB1){
                ov8856jslmipirawjslmipirawjslmipirawjslmipirawversion = OV8856JSLMIPIRAWJSLMIPIRAWR2A;
                LOG_INF("i2c write id: 0x%x, sensor id: 0x%x, ov8856jslmipirawjslmipirawjslmipirawjslmipirawversion = %d(0=r2a,1=r1a)\n", imgsensor.i2c_write_id,*sensor_id,ov8856jslmipirawjslmipirawjslmipirawjslmipirawversion);	
                return ERROR_NONE;
              }
              else{
                LOG_INF("read ov8856jslmipirawjslmipirawjslmipirawjslmipiraw R1A R2A bate fail\n");	  
...
static kal_uint32 open(void)
{
	...
	mdelay(30);
	#ifdef OV8856JSLMIPIRAWJSLMIPIRAWR1AOTP
  ...
  ov8856jslmipirawjslmipirawjslmipirawjslmipirawjslmipiraw_update();	
...
UINT32 OV8856JSLMIPIRAWJSLMIPIRAWJSLMIPIRAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
