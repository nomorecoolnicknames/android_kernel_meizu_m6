...
#define TPD_KEYS_DIM	{{key_1, 20, TPD_BUTTON_HEIGH},\
							{key_2, 20, TPD_BUTTON_HEIGH},\
							{key_3, 20, TPD_BUTTON_HEIGH} }
#endif
...
#if 1
#define FTS_INFO(fmt, arg...)           pr_debug("[FTS-INFO] "fmt"\n", ##arg)
#else
#define FTS_INFO(fmt, arg...)
#endif
#define FTS_ERROR(fmt, arg...)          pr_err("[FTS-ERROR] "fmt"\n", ##arg)
